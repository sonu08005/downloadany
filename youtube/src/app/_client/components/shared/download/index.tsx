    ...
    const mappedDownloadables = downloadables.map((downloadable, index) => (
      <div 
        ...
        <div className="lg:basis-1/2">
          ...
          <iframe style={{ width: "100%", border: "none", maxWidth: "564px", height: "60px", overflow: "hidden" }} src={`https://p.oceansaver.in/api/button2/?url=${downloadable.url}&f=${downloadable.format.value}&color=black&linkUrl=${ADS_URL ? `${ADS_URL}` : ""}&css=CSS_URL`}></iframe>
        </div>
      </div>
    ))
